...
/// <summary>
/// <see cref="ServerUrl"/> is the server in use; <see cref="Servers"/> is the saved list.
///
/// <para>Пустой <see cref="ServerUrl"/> — это не ошибка и не «ещё не загрузилось», а законное
