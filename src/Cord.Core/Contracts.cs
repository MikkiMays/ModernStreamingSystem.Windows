...
public sealed record HostMessage(string Type, string? Page = null, string? RoomId = null, string? Theme = null, int Version = 1, string? Name = null, string? Detail = null, bool? ShowPing = null, bool? NotificationSounds = null, string? Token = null, long? ExpiresAt = null, string? ServerName = null);
